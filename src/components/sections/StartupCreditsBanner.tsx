      ...
      <div className="relative flex-grow flex flex-col p-6 lg:p-8">
        <div className="flex items-start justify-between gap-6 flex-wrap">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium border border-teal-500/40 text-teal-400 hover:border-teal-400 hover:bg-teal-500/10 transition-all duration-200 group/btn flex-shrink-0 self-start"
          >
            <span>Apply Now</span>
            <ArrowRight
              size={14}
